...
def forward(w,b,a,Y,L,m):#前向传播
    ...
    return z,a,J
def backward(w,b,X,Y,learning,m,L):#反向传播
    z,a,J = forward(w,b,X,Y,L,m)
...
if __name__ == "__main__":
    ...
    for i in range(5000):
        w,b,J = backward(w,b,train_set_x,train_set_y,learning,train_set_x.shape[1],L)
        if i % 500 == 0:
            print("loss：",J)
            loss.append(J)
